...
const OrderCard = () => {
  return (
    <div className='w-[400px] bg-[#262626] p-4 rounded-lg mb-4 ml-10'>
    <div className='flex items-center gap-5'>
      ...
      <div className='flex items-center justify-between w-[100%]'>
        <div className='flex flex-col items-start gap-1'>
            <h1 className='text-[#f5f5f5] text-lg font-semibold tracking-wide'>Rachit Agarwal</h1>
      ...
      <div className='flex items-center justify-between mt-4'>
        <h1 className='text-[#f5f5f5] text-lg font-semibold mt-2'>Total</h1>
        <p className='text-[#f5f5f5] text-lg font-semibold mt-2'>₹250.50</p>
      </div>
    </div>
  )
}
